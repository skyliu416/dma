...
export default {
  ...
  methods: {
    gotoNext(){
      ...
      this.$router.push('/dma/assessment5')
    },
    change(v) {
  ...
  data() {
    return {
      ...
      q3: {
        q: "3. 是否拥有成熟的团队指导和推进信息技术与数据安全数字化项目？",
        a: {
          1: "1 起步阶段",
          2: "2 正在发展",
          3: "3 达到标准",
      ...
      q4: {
        q: "4. 是否已经在信息技术与数据安全数字化项目上应用新兴技术？",
        a: {
          1: "1 起步阶段",
          2: "2 逐步了解",
          3: "3 充分应用",
