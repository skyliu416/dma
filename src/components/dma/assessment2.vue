  ...
  <div class="assessment">
    <div class="title">
      ...
      <div class="barslide">
        ...
        <div class="bar borderYellow fontWhite">数字化客户体验</div>
...
export default {
  ...
  methods: {
    gotoNext(){
      ...
      localStorage.setItem('q2', JSON.stringify(result))
      this.$router.push('/dma/assessment3')
    },
    change(v) {
  ...
  data() {
    return {
      ...
      q4: {
        q: "4. 是否已经在客户体验优化项目上应用新兴技术，从而实时、客观、全面地聆听客户声音？",
        a: {
          1: "1 起步阶段",
          2: "2 逐步了解",
          3: "3 充分应用",
