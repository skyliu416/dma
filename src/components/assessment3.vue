  ...
  <div class="assessment">
    <div class="title">
      ...
      <div class="barslide">
        ...
        <div class="bar borderYellow fontWhite">智能运营与决策</div>
...
export default {
  ...
  data() {
    return {
      ...
      value5: 1,
      q1: {
        q: "1. 是否拥有清晰的针对智能运营与数据驱动决策的数字化创新战略？",
        a: {
          1: "1 起步阶段",
          2: "2 正在发展",
          3: "3 达到标准",
      ...
      q2: {
        q: "2. 是否充分熟悉行业内外针对智能运营与数据驱动决策的数字化创新的最佳实践案例？",
        a: {
          1: "1 起步阶段",
          2: "2 正在发展",
          3: "3 充分熟悉",
      ...
      q3: {
        q: "3. 是否拥有成熟的数字化+业务团队负责领导和执行智能运营与数据驱动决策的创新项目？",
        a: {
          1: "1 起步阶段",
          2: "2 正在发展",
          3: "3 达到标准",
      ...
      q4: {
        q: "4. 否了解且已经将新兴技术应用在智能运营与数据驱动决策的创新项目（如数字化供应链、数据中台等）？",
        a: {
          1: "1 起步阶段",
          2: "2 逐步了解",
          3: "3 充分应用",
      ...
      q5: {
        q: "5. 是否在智能运营与数据驱动决策方面的创新规划中，有成熟的生态合作伙伴？",
        a: {
          1: "1 起步阶段",
          2: "2 正在发展",
          3: "3 达到标准",
